...
function Navbar({ isOpen, toggle }) {
  ...
  return (
    <>
      <div className='lg:flex lg:flex-row flex-col lg:bg-gray-100 xl:w-60 w-38 lg:h-screen h-14'>
        <div className='lg:sticky fixed top-0 w-full backdrop-filter backdrop-blur-md text-gray-700'>
          ...
          <div
            className={
              isOpen ? 'flex flex-col px-4 pb-4 lg:pb-0 h-full' : 'hidden'
            }
            ...
            <div className='px-4 py-2 mt-2 mb-3 text-xs font-semibold flex-col flex-1 text-center text-gray-400'>
              <span className='flex justify-center'>Last Synced:</span>
