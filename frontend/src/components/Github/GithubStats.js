...
function GitHubStats() {
  ...
  user_link = githubUserData.link;
  user_name = githubUserData.name;
  ...
  return (
    <>
      {githubRepositories && githubUserData ? (
              ...
              <div className='border border-border rounded-xl px-5 py-3 shadow-soft mb-body bg-white'>
                <div className='flex justify-between'>
                  ...
                  <div className='flex flex-col'>
                    ...
                    <span className='text-xs font-semibold text-gray-600'>
                      <CountUp
                        end={githubUserData.total_repos}
                        duration={1.2}
                        delay={0.04}
                      />
                    </span>
                  ...
                  <div className='flex flex-col'>
                    ...
                    <span className='text-xs font-semibold text-gray-600'>
                      <CountUp
                        end={githubUserData.total_stars}
                        duration={1.2}
                        delay={0.04}
                      />
                    </span>
                  ...
                  <div className='flex flex-col'>
                    ...
                    <span className='text-xs font-semibold text-gray-600'>
                      <CountUp
                        end={githubUserData.total_forks}
                        duration={1.2}
                        delay={0.04}
                      />
                    </span>
                  ...
                  <div className='flex flex-col'>
                    ...
                    <span className='text-xs font-semibold text-gray-600'>
                      <CountUp
                        end={githubUserData.total_gists}
                        duration={1.2}
                        delay={0.04}
                      />
                    </span>
                ...
                <div className='md:text-lg text-base mb-5 font-semibold text-gray-700 flex justify-between'>
                  <Link
                    ...
                    <div className='my-auto'>
                      {repoData ? repoData.name : 'Active Repo'}
                    </div>
                    <div className='m-auto ml-2.5'>
                      <hi.HiExternalLink size={12} color={'#404040'} />
                    </div>
                                  ...
                                  <div>
                                    ...
                                    <div className='flex font-semibold text-gray-600'>
                                      <svg
                                        ...
                                        width='10'
                                        height='10'
                                        className='m-auto ml-0 mr-5px fill-current'>
                                        <path
                                          fill-rule='evenodd'
